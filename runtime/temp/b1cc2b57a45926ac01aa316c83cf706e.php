<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\phpStudy\WWW/application/testcase\view\node_management\index.html";i:1517756360;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
  <meta charset="utf-8">
                            ...
                            <form class="form form-horizontal">
                              ...
                              <div class="row cl">
                                <div class="col-9 col-offset-2">
                                 <span class="l">
                                  <a class="btn btn-primary radius" onclick="addNode()" id="btnAdd" style="display: none;"><i class="Hui-iconfont">&#xe632;</i> 添加子节点</a> 
                                  <a id="btnDel" onclick="delNode()" class="btn btn-danger radius" style="display: none;"><i class="Hui-iconfont">&#xe6e2;</i> 删除节点</a> 
                                  <a id="btnSave" onclick="saveNode()" class="btn btn-success radius" style="display: none;"><i class="Hui-iconfont">&#xe632;</i> 保存节点</a> </span>  
                                </div>
                              </div>
                            </form>
                          </td>
