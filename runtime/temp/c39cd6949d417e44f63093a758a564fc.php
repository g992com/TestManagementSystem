<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:117:"D:\phpStudy\TestManagementSystem\htdocs/application/listtestcase\view\list_testcase_management\add_testcase_page.html";i:1533694585;}*/ ?>
﻿<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    //$('#testType').val('功能测试');
    //$("#testType option").filter("[text='功能测试']").attr("selected", true);
