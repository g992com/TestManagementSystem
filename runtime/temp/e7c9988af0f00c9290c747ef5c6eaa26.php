<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\WWW/application/testtool\view\test_tool_management\create_host_page.html";i:1531851554;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <![endif]-->
    <!--/meta 作为公共模版分离出去-->
    <title>添加Host文本</title>
</head>
<body>
<article class="page-container">
    <form class="form form-horizontal" id="form-host-add">
        <input type="text" id="realName" name="realName" value="<?php echo $realName; ?>" style="display: none;"/>
        <input type="text" id="serverIp" name="serverIp" value="<?php echo \think\Config::get('SERVER_IP'); ?>" style="display: none;"/>
...
<script type="text/javascript">
    ...
    function submitInfo() {
        var options = {
            url: '__TestToolURL__/test_tool_management/createHostText',
            type: 'POST',
            dataType: 'json',
        ...
        $('#form-host-add').ajaxSubmit(options);
    }
</script>
</body>
</html>