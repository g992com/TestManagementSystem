<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpStudy\TestManagementSystem\htdocs/application/index\view\index\index.html";i:1533288233;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
...
<head>
    ...
    <meta name="keywords" content="测试用例管理系统(TMS)">
    <meta name="description" content="测试用例管理系统(TMS)">
</head>
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl>
            ...
            <dd>
                <ul>
                    ...
                    <li>
                        <a data-href="__ListTestCaseURL__/share_management" data-title="分享管理"
                           href="javascript:void(0)"> 分享管理</a>
                    </li>
                    <li>
                        <a data-href="__ListTestCaseURL__/base_testcase_management" data-title="基线用例"
                           href="javascript:void(0)"> 基线用例</a>
                    </li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li>
                        <a data-href="__ScheduleURL__/hr_schedule_management" data-title="人员排期"
                           href="javascript:void(0)"> 人员排期</a>
                    </li>
                    <li>
                        <a data-href="__ScheduleURL__/plan_schedule_management?planId=0" data-title="项目排期"
                           href="javascript:void(0)"> 项目排期</a>
                    </li>
                    <!--
                    <li>
        ...
        <dl id="">
            ...
            <dd>
                <ul>
                    ...
                    <li>
                        <a data-href="https://www.json.cn/" data-title="Json格式化"
                           href="javascript:void(0)"> Json格式化</a>
                    </li>
                </ul>
            </dd>
        </dl>
